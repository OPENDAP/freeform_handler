...
static char rcsid[] not_used ="$Id: DODS_StartTime_Factory.cc,v 1.2 2000/08/31 22:16:54 jimg Exp $";
...
DODS_StartTime_Factory::DODS_StartTime_Factory(DDS &dds, DAS &das)
{
    ...
    if (!at)
	throw Error(unknown_error, "DODS_StartTime_Factory requires that the DODS_Time attribute be present.");
